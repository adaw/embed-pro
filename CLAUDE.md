...
Single-file FastAPI server (`embed-pro`) providing OpenAI-compatible embedding and reranking endpoints using BGE models on Apple MPS (Metal Performance Shaders).
...
# Custom port
PORT=9000 python embed-pro

# Custom model paths (defaults to /Users/adam/models/bge-m3 and /Users/adam/models/bge-reranker-v2-m3)
BGE_M3_PATH=/path/to/model BGE_RERANKER_PATH=/path/to/reranker python embed-pro
```
...
- The main file has no `.py` extension — it's a standalone executable script
